<?php /* Smarty version Smarty-3.1.18, created on 2014-11-02 16:36:26
         compiled from "C:\xampp\htdocs\Underfashion\design\backend\templates\views\tabs\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17045456254ae56d21-51014765%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acf65196140251fcd8de32d3b4d0ebe2dfee3b6b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Underfashion\\design\\backend\\templates\\views\\tabs\\manage.tpl',
      1 => 1414707660,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17045456254ae56d21-51014765',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5456254b3936a3_66645912',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5456254b3936a3_66645912')) {function content_5456254b3936a3_66645912($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\function.script.php';
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php ob_start();?><?php echo $_smarty_tpl->__("editing_tab");?>
...
<?php if (!$_smarty_tpl->tpl_vars['dynamic_object']->value) {?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
        <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('act'=>"general",'id'=>"add_tab",'text'=>__("new_tab"),'title'=>__("add_tab"),'icon'=>"icon-plus",'href'=>"tabs.update",'action'=>"tabs.update",'opener_ajax_class'=>"cm-ajax",'link_class'=>"cm-ajax-force",'content'=>''), 0);?>
...
<?php if (!$_smarty_tpl->tpl_vars['dynamic_object']->value) {?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("product_tabs"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'select_languages'=>true), 0);?>
