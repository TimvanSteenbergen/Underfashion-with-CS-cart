<?php /* Smarty version Smarty-3.1.18, created on 2014-11-02 16:36:18
         compiled from "C:\xampp\htdocs\Underfashion\design\backend\templates\views\products\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:719754562542e63eb5-90500926%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06a7796bd8a64a2b3435f9e733cee2df51758a5e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Underfashion\\design\\backend\\templates\\views\\products\\update.tpl',
      1 => 1414707660,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '719754562542e63eb5-90500926',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_545625445e85e5_85608641',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545625445e85e5_85608641')) {function content_545625445e85e5_85608641($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\Underfashion\\app\\lib\\other\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\modifier.enum.php';
...
" <?php ob_start();?><?php echo htmlspecialchars(smarty_modifier_enum("ProductTracking::TRACK_WITHOUT_OPTIONS"), ENT_QUOTES, 'UTF-8');?>
<?php $_tmp1=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['product_data']->value['tracking']==$_tmp1&&$_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']=="Y") {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("track_without_options");?>
</option>
                                <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductTracking::DO_NOT_TRACK"), ENT_QUOTES, 'UTF-8');?>
" <?php ob_start();?><?php echo htmlspecialchars(smarty_modifier_enum("ProductTracking::DO_NOT_TRACK"), ENT_QUOTES, 'UTF-8');?>
<?php $_tmp2=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['product_data']->value['tracking']==$_tmp2||$_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']=="N") {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("dont_track");?>
</option>
                            </select>
                        </div>
                    </div>
...
<?php $_tmp3=ob_get_clean();?><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_tmp3.": ".((string)$_smarty_tpl->tpl_vars['product_data']->value['product'])), ENT_QUOTES, 'UTF-8');?>
