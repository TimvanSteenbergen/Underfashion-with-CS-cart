<?php /* Smarty version Smarty-3.1.18, created on 2014-11-02 16:36:04
         compiled from "C:\xampp\htdocs\Underfashion\design\backend\templates\views\products\components\products_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:65725456253453b677-00748395%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7e34451eda6a97125e8366c74393908621183e8c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Underfashion\\design\\backend\\templates\\views\\products\\components\\products_search_form.tpl',
      1 => 1414707660,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '65725456253453b677-00748395',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_545625351d47b4_30671464',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545625351d47b4_30671464')) {function content_545625351d47b4_30671464($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_truncate')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\modifier.truncate.php';
?><?php
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_page_part']->value, ENT_QUOTES, 'UTF-8');?>
...
<div class="control-group">
    ...
    <span id="on_filter" class="exicon-expand cm-save-state <?php if ($_COOKIE['filter']) {?>hidden<?php }?>"> </span>
    <span id="off_filter" class="exicon-collapse cm-save-state <?php if (!$_COOKIE['filter']) {?>hidden<?php }?>"></span>
    <?php echo $_smarty_tpl->__("search_by_product_filters");?>
</a>

    <div class="controls">
        <div id="filter"<?php if (!$_COOKIE['filter']) {?> class="hidden"<?php }?>>
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/advanced_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('filter_features'=>$_smarty_tpl->tpl_vars['filter_items']->value,'prefix'=>"filter_"), 0);?>
...
<div class="group form-horizontal">
    <div class="control-group">
        ...
        <a class="search-link cm-combination nowrap open cm-save-state" id="sw_feature"><span id="on_feature" class="cm-combination cm-save-state <?php if ($_COOKIE['feature']) {?>hidden<?php }?>"><span class="exicon-expand"></span></span><span id="off_feature" class="cm-combination cm-save-state <?php if (!$_COOKIE['feature']) {?>hidden<?php }?>"><span class="exicon-collapse"></span></span><?php echo $_smarty_tpl->__("search_by_product_features");?>
</a>

        <div class="controls">
        <div id="feature"<?php if (!$_COOKIE['feature']) {?> class="hidden"<?php }?>>
            <input type="hidden" name="advanced_filter" value="Y" />
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/advanced_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('filter_features'=>$_smarty_tpl->tpl_vars['feature_items']->value,'prefix'=>"feature_"), 0);?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:search_form"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <div class="group span6 form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $_smarty_tpl->getSubTemplate ("pickers/orders/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('item_ids'=>$_smarty_tpl->tpl_vars['search']->value['order_ids'],'no_item_text'=>__("no_items"),'data_id'=>"order_ids",'input_name'=>"order_ids",'view_mode'=>"simple"), 0);?>
