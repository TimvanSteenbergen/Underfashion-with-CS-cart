<?php /* Smarty version Smarty-3.1.18, created on 2014-11-02 16:36:06
         compiled from "C:\xampp\htdocs\Underfashion\design\backend\templates\pickers\orders\picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:936854562536278c73-43895129%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b15f913f74a04accd6a6a16451639378cd904dab' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Underfashion\\design\\backend\\templates\\pickers\\orders\\picker.tpl',
      1 => 1414707660,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '936854562536278c73-43895129',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_545625368ba6f1_85321993',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545625368ba6f1_85321993')) {function content_545625368ba6f1_85321993($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\Underfashion\\app\\lib\\other\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\function.script.php';
?><?php
...
_clear" class="reload-container<?php if (!$_smarty_tpl->tpl_vars['item_ids']->value) {?> hidden<?php }?>">
                    <?php ob_start();?><?php echo htmlspecialchars(fn_url("orders.manage?order_id="), ENT_QUOTES, 'UTF-8');?>
...
?>
    ...
    <span id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
_details"<?php if (count($_smarty_tpl->tpl_vars['item_ids']->value)<=$_smarty_tpl->tpl_vars['max_displayed_qty']->value) {?> class="hidden"<?php }?>><a href="<?php echo htmlspecialchars(fn_url("orders.manage?order_id="), ENT_QUOTES, 'UTF-8');?>
<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?><?php echo htmlspecialchars(implode(',',$_smarty_tpl->tpl_vars['item_ids']->value), ENT_QUOTES, 'UTF-8');?>
<?php }?>">..</a></span>
    <span id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
...
?>
        ...
        <?php } ?>
        <tr class="no-items <?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?>hidden<?php }?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
_no_item">
            <td colspan="<?php if (!$_smarty_tpl->tpl_vars['view_only']->value) {?>6<?php } else { ?>5<?php }?>"><?php echo $_smarty_tpl->tpl_vars['no_item_text']->value;?>
</td>
        </tr>
        </tbody>
    </table>
