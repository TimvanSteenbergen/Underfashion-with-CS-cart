<?php /* Smarty version Smarty-3.1.18, created on 2014-11-02 16:39:42
         compiled from "C:\xampp\htdocs\Underfashion\design\themes\responsive\templates\views\products\components\product_options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:317955456260ed4dca8-59302026%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bdc5ed28a6da9aaf143766017ac3eae60cf41a45' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Underfashion\\design\\themes\\responsive\\templates\\views\\products\\components\\product_options.tpl',
      1 => 1414716900,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '317955456260ed4dca8-59302026',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5456261114ff90_45115057',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5456261114ff90_45115057')) {function content_5456261114ff90_45115057($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\block.hook.php';
...
">
        <?php if (!(strpos("SRC",$_smarty_tpl->tpl_vars['po']->value['option_type'])!==false&&!$_smarty_tpl->tpl_vars['po']->value['variants']&&$_smarty_tpl->tpl_vars['po']->value['missing_variants_handling']=="H")) {?>
            <label <?php if ($_smarty_tpl->tpl_vars['po']->value['option_type']!=="R"&&$_smarty_tpl->tpl_vars['po']->value['option_type']!=="F") {?>for="option_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> class="ty-control-group__label ty-product-options__item-label<?php if ($_smarty_tpl->tpl_vars['po']->value['required']=="Y") {?> cm-required<?php }?><?php if ($_smarty_tpl->tpl_vars['po']->value['regexp']) {?> cm-regexp<?php }?>" <?php if ($_smarty_tpl->tpl_vars['po']->value['regexp']) {?>data-ca-regexp="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['regexp'], ENT_QUOTES, 'UTF-8');?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
" class="ty-product-options__textarea<?php if ($_smarty_tpl->tpl_vars['po']->value['inner_hint']) {?> cm-hint<?php }?><?php if ($_smarty_tpl->tpl_vars['product']->value['exclude_from_calculate']&&!$_smarty_tpl->tpl_vars['product']->value['aoc']) {?> disabled<?php }?>" rows="3" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
][product_options][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?>"><?php echo $_smarty_tpl->__("nocombination");?>
</p>
<?php }?>
<?php }?>
