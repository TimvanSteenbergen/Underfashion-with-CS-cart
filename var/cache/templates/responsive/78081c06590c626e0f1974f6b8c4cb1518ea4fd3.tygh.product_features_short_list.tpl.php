<?php /* Smarty version Smarty-3.1.18, created on 2014-11-02 16:39:46
         compiled from "C:\xampp\htdocs\Underfashion\design\themes\responsive\templates\views\products\components\product_features_short_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1820545626123b19b8-53688905%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78081c06590c626e0f1974f6b8c4cb1518ea4fd3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Underfashion\\design\\themes\\responsive\\templates\\views\\products\\components\\product_features_short_list.tpl',
      1 => 1414716900,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1820545626123b19b8-53688905',
  'function' => 
  array (
    'feature_value' => 
    array (
  ...
  'unifunc' => 'content_545626129f72a5_55047224',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545626129f72a5_55047224')) {function content_545626129f72a5_55047224($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\function.set_id.php';
?><?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C") {?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\modifier.date_format.php';
...
<?php }?><?php }?><?php } else { ?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\modifier.date_format.php';
?><?php if (!function_exists('smarty_template_function_feature_value')) {
    function smarty_template_function_feature_value($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['feature_value']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
