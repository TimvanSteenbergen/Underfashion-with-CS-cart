<?php /* Smarty version Smarty-3.1.18, created on 2014-11-03 10:46:03
         compiled from "C:\xampp\htdocs\Underfashion\design\themes\responsive\templates\views\products\components\product_notification_items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18896545724ab968471-79671741%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bdbb5f734ca5e0e5de99364472154edb35eb4103' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Underfashion\\design\\themes\\responsive\\templates\\views\\products\\components\\product_notification_items.tpl',
      1 => 1414716900,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18896545724ab968471-79671741',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_545724abdbe7d0_15955409',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545724abdbe7d0_15955409')) {function content_545724abdbe7d0_15955409($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/Underfashion/app/functions/smarty_plugins\\block.hook.php';
...
?><?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C") {?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:notification_items")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:notification_items"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])) {?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="views/products/components/product_notification_items.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/product_notification_items.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit ty-icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php } else { ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php } else { ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:notification_items")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:notification_items"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
